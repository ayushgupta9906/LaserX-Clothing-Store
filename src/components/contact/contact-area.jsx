                ...
                <div className="tp-contact-info-wrapper">
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      ...
                      <p data-info="phone">
                        <a href="tel:91 7906 150 152">+91 7906 150 152</a>
                      </p>
                    </div>
                  </div>
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <p>
                        <a
                          href="https://maps.app.goo.gl/e4AiMVCr4fLzDq817"
                          target="_blank"
                        >
                          105/21 Green Park Colony
                         <br />  Bareilly, Uttar Pradesh, India 243006
                        </a>
                      </p>
                    </div>
                  </div>
